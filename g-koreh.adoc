...
Leader:: Preserving a bond with the observance of our ancestors, we follow a
...
Leader:: Throughout history good teachers have understood that different kinds of people learn better in different ways.

A Participant:: The *wise* person asks, "`What led to the Passover seder as it
...
A Participant:: The *simple* person asks, "`What is this?`" To that person we
...
A Participant:: The *wicked* person says, "`What is this observance to _you_?`"
...
A Participant:: With the person *unable to ask*, you must begin telling the
...
Leader:: As in the pages of our histories, so too in the events of our time, in
